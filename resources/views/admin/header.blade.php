<header class="header " style="color:rgb(17, 240, 69)">
    <nav class="navbar navbar-expand-lg py-1" style="background-color:rgb(17, 240, 69)">
        ...
        <div  class="container-fluid d-flex align-items-center justify-content-between">
            <div class="navbar-header" style="color:rgb(14, 243, 67)">
            ...
            <div class="right-menu list-inline no-margin-bottom">
                ...
                <!-- Log out               -->
                <div class="list-inline logout"></div>
